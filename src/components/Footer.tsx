...
export default function Footer() {
  return (
    <footer className="bg-[#1C1917] text-white/70">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-1">
            <Link href="/" className="flex items-center gap-2.5 mb-4">
              ...
              <span className="text-lg font-bold text-white">PromptVault</span>
            </Link>
            <p className="text-sm leading-relaxed">
              Premium AI prompts for web designers and developers. Build stunning websites in minutes.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li><Link href="/catalog" className="text-sm hover:text-white transition-colors">Browse Prompts</Link></li>
              <li><Link href="/pricing" className="text-sm hover:text-white transition-colors">Pricing</Link></li>
              <li><Link href="/catalog" className="text-sm hover:text-white transition-colors">Free Prompts</Link></li>
              <li><Link href="/catalog" className="text-sm hover:text-white transition-colors">Premium Prompts</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li><Link href="/" className="text-sm hover:text-white transition-colors">Support</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-white/40">© 2026 PromptVault. All rights reserved.</p>
